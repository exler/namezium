<x-app-layout>
    <div id="name">
        ...
        <div id="name-availability" class="container max-w-4xl mx-auto">
            ...
            <div id="domain-availability" class="grid items-center grid-cols-5 p-2 border border-gray-200">
                ...
                <div class="flex flex-col items-center justify-between col-span-5 mt-4 space-y-4 sm:mt-0 sm:space-y-0 sm:flex-row sm:col-span-3">
                    ...
                    <div class="flex flex-row items-center space-x-12 sm:space-x-0 sm:items-start sm:flex-col">
                        <span class="text-base">$25.99</span>
                        <span class="text-2xl font-black">$0.99/yr</span>
                    </div>
                    <a href="#" class="flex items-center justify-center w-full p-2 text-white bg-red-600 sm:w-auto rounded hover:bg-red-900">
