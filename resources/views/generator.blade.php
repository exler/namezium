    ...
    <div id="generator">
        ...
        <div id="names" class="border-solid border-2 rounded-sm lg:w-3/4 pt-2 m-auto">
            <div class="sm:flex sm:items-center px-2">
                <div class="flex-grow">
                    <div class="w-full">
                        @forelse ($generator->names->random(10) as $name)
            ...
            <div class="sm:flex bg-grey-light sm:items-center px-2 py-4">
                <div class="flex-grow text-center">
                    <button onclick="location.reload()" class="flex items-center lg:w-1/6 m-auto p-2 bg-blue-200 rounded-lg shadow-xs cursor-pointer hover:bg-blue-500 hover:text-gray-100">
